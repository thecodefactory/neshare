...
#ifndef __NEMSGENTRYSETEND_H
#define __NEMSGENTRYSETEND_H

typedef struct
{
    unsigned long msgType;
    unsigned long numEntries;
} NEMSGENTRYSETEND_HEADER;

class nemsgEntrySetEnd : public nemsgCommon
{
  public:
    nemsgEntrySetEnd(ncSocket *sock);
    ~nemsgEntrySetEnd();
   
    /*
      sends an NE_MSG_ENTRY_SET_END message over the socket.
    ...
    */
    ...
    /*
      reads an NE_MSG_ENTRY_SET_END message over the socket
